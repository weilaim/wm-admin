...
import (
	...
	"github.com/weilaim/wm-admin/server/router"
)
...
func Routers() *gin.Engine {
	...
	// 如果不想使用nginx代理前端网页，可以修改web/.env.production下的
	// VUE_APP_BASE_API = /
	...
	PublicGroup := Router.Group("")
	{
		...
		PublicGroup.GET("/health", func(c *gin.Context) {
			c.JSON(http.StatusOK, "ok-程序是健康")
		})
	}
	{
		systemRouter.InitBaseRouter(PublicGroup) // 注册基础路由功能路由 不做鉴权
